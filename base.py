...
def score(name):
    ...
    speak("Your mental assessment score is " + str(sc))
    if(sc >=0 and sc <=9):
        print(Fore.RED + bot.format("Please make sure that you keep checking in with me. What's your mood now after opening up?"))
...
def extreme(name):
    print(Fore.RED + bot.format("We\'re really sorry to know that and for further assistance we would try to connect you with our local assistance who is available 24/7"))
    speak("We\'re really sorry to know that and for further assistance we would try to connect you with our local assistance who is available 24/7")
    time.sleep(1)
    print(Fore.RED + bot.format("Here are the details",name))
    print(Fore.RED + bot.format("Contact Jeevan Suicide Prevention Hotline"))
    print(Fore.RED + bot.format("Address:171, Ambiga Street Golden George Nagar, Nerkundram, Chennai, Tamil Nadu 600107"))
...
def quiz(name):
    time.sleep(1)
    print(Fore.RED + bot.format("Now we're starting with a small assessment and hopefully at the end of the assessment,we'll be able to evaluate your mental health"))
    speak("Now we're starting with a small assessment and hopefully at the end of the assessment,we'll be able to evaluate your mental health")
    print(Fore.RED)
    time.sleep(0.8)
...
def cbt():
    time.sleep(1)
    print(Fore.RED + bot.format("Mood tracking and thinking hygiene - among other useful concepts - are skills you'll learn as you practice CBT"))
    speak("Mood tracking and thinking hygiene - among other useful concepts - are skills you'll learn as you practice CBT")
    time.sleep(1)
    print(Fore.RED + bot.format("Skills that can help you make positive changes to your thoughts, feelings and behaviour"))
...
def depression(name):
    ...
    time.sleep(1)
    print(Fore.RED + bot.format('There you go...let it all slide out.Unhappiness cannot stick in a person\'s soul when it\'s slick with tear.'))
    speak('There you go...let it all slide out.Unhappiness cannot stick in a person\'s soul when it\'s slick with tear.')
...
def anxiety(name):
    ...
    speak('Here is a thought that might motivate you!')
    time.sleep(1)
    print(Fore.RED + bot.format('Take a deep breath, listen to your thoughts, try to figure them out. Then take things one day at a time.'))
...
def sleeping_disorder(name):
    ...
    speak('Here is a thought that might motivate you!')
    time.sleep(1)
    print(Fore.RED + bot.format('Overhead, the glass envelope of the Insomnia Balloon is malfunctioning. It blinks on and off at arrhythmic intervals, making the world go gray:black, gray:black. In the distance, a knot of twisted trees flashes like cerebral circuitry.'))
    speak('Overhead, the glass envelope of the Insomnia Balloon is malfunctioning. It blinks on and off at arrhythmic intervals, making the world go gray:black, gray:black. In the distance, a knot of twisted trees flashes like cerebral circuitry.')
...
def personality_disorder(name):
    ...
    speak('Here is a thought that might motivate you!')
    time.sleep(1)
    print(Fore.RED + bot.format('...repeated trauma in childhood forms and deforms the personality. The child trapped in an abusive environment is faced with formidable tasks of adaptation. She must find a way to preserve a sense of trust in people who are untrustworthy, safety in a situation that is unsafe, control in a situation that is terrifyingly unpredictable, power in a situation of helplessness. Unable to care for or protect herself, she must compensate for the failures of adult care and protection with the only means at her disposal, an immature system of psychological defenses.'))
    speak('...repeated trauma in childhood forms and deforms the personality. The child trapped in an abusive environment is faced with formidable tasks of adaptation. She must find a way to preserve a sense of trust in people who are untrustworthy, safety in a situation that is unsafe, control in a situation that is terrifyingly unpredictable, power in a situation of helplessness. Unable to care for or protect herself, she must compensate for the failures of adult care and protection with the only means at her disposal, an immature system of psychological defenses.')
...
def substance_abuse(name):
    ...
    speak('Here is a thought that might motivate you!')
    time.sleep(1)
    print(Fore.RED + bot.format(' My Recovery Must Come First So That Everything I Love In Life Doesn’t Have To Come Last.'))
